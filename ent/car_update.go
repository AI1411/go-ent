...
func (cu *CarUpdate) SetRegisteredAt(s string) *CarUpdate {
	cu.mutation.SetRegisteredAt(s)
	return cu
}
...
// SetRegisteredAt sets the "registered_at" field.
func (cuo *CarUpdateOne) SetRegisteredAt(s string) *CarUpdateOne {
	cuo.mutation.SetRegisteredAt(s)
	return cuo
}
