...
import (
	...
	"github.com/AI1411/go-ecom/ent/car"
	"github.com/AI1411/go-ecom/ent/group"
...
func (m *CarMutation) SetRegisteredAt(s string) {
	m.registered_at = &s
}

// RegisteredAt returns the value of the "registered_at" field in the mutation.
func (m *CarMutation) RegisteredAt() (r string, exists bool) {
	v := m.registered_at
	if v == nil {
		return
	}
...
// If the Car object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CarMutation) OldRegisteredAt(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
